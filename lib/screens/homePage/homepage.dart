  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: CustomBottomNavigationBar(
        backgroundColor: _isIndex1 ? greyShade900 : Theme.of(context).colorScheme.surface ,
          ...
          slivers: [
            SliverAppBar(
              ...
              bottom: PreferredSize(
                  preferredSize: Size.fromHeight(ScreenSize.screenHeight(context) * 0.05),
                  child: Column(
                    children: [
                      categoryListView(),
            ...
            SliverToBoxAdapter(
              ...
              child: isAllCategorySelected ? BlocBuilder<AllVideoListBloc, AllVideoListState>(
                  builder: (BuildContext context, state){
                    if(state is VideoListLoading){
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      SizedBox(width: 8),
                                      ShimmerWidget.circular(width: 40, height: 40, isBorder: true),
                                      SizedBox(width: 8),
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          ShimmerWidget.rectangular(height: 16, width: 120, isBorder: true,),
                                          SizedBox(height: 8),
                                          ShimmerWidget.rectangular(height: 16, width: 200, isBorder: true,),
                                        ],
                                      ),
                                    ],
                                  ),
                      ...
                      return ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            int totalSeconds = state.videoList[index].duration!; // Example seconds
                ...
                builder: (BuildContext context, state) {
                  if(state is VideoListLoading){
                    ...
                    return state.videoList.isNotEmpty ? ListView.builder(
                        shrinkWrap: true,
                        physics: const NeverScrollableScrollPhysics(),
                        padding: EdgeInsets.only(
                            top: ScreenSize.screenHeight(context) * 0.02
                      ...
                      child: Center(child: Image.asset('assets/images/no_data.jpg', width: 200, height: 200,)),
                    );
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: isAllCategorySelected ? primaryColor : primaryLightColor,
                      ...
                      child: Center(
                        child: Text(
                          'All',
                          style: TextStyle(
                            color: isAllCategorySelected ? Colors.white : Colors.black87,
                            fontSize: 11,
                            fontFamily: fontFamily,
                      ...
                      return Padding(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            ...
                            context.read<VideoListBloc>().add(GetVideoListEvent(categoryId: state.categories[index].id!));
                          },
                          child: Container(
                            decoration: BoxDecoration(
                              color:  isAllCategorySelected
                                  ? Colors.blue.shade50
                                  : index == state.selectedCategory ? primaryColor : primaryLightColor,
                              // color:  isAllCategorySelected
                            ...
                            child: Center(
                              child: Text(
                                ...
                                style: TextStyle(
                                  color: isAllCategorySelected
                                      ? Colors.black87
                                      : index == state.selectedCategory ? Colors.white : Colors.black87,
                                  fontSize: 11,
                                  fontFamily: fontFamily,
                                  fontWeight: FontWeight.w400,
                                ),
